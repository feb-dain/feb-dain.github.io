...
<p>
  <b>SEO란?</b> 검색 엔진 최적화(search engine optimization)의 준말로 구글이나 네이버, 다음 등과 같은 검색 엔진에서 검색이 잘 되도록 하는 것을 말한다. <br>
...
하단의 `사이트 목록의 링크` 클릭 -> `검증` -> `웹 페이지 최적화`에서 <span style="background:green">확인<span> 버튼을 누르면<br><br>
